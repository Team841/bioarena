...
echo ""
echo "On Windows, deploy-pi.ps1 does all of the below in one command:"
echo "       .\\deploy-pi.ps1                  # code change only, copies one file"
echo "       .\\deploy-pi.ps1 -Assets -Service # when those changed too"
echo ""
